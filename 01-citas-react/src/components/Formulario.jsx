  ...
  return (
    <div className="md:w-1/2 lg:w-3/5 mb-10">
      ...
      <form onSubmit={handleSubmit} action="" className="bg-white shadow-md rounded-lg py-10 px-5 mx-5">
        ...
        <input type="submit" className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 rounded cursor-pointer transition-colors" value={paciente.id ? 'Editar Paciente' : 'Agregar paciente'} />
      </form>
    </div>
  )
}
